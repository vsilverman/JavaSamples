...
public class MyTraverseDirectory {
	
	public static String MY_DIR = "d:\\Flash1\\dev";
    ...
    public static void main(String[] args) {
		...
		if (args.length < 1) {
			System.out.println("Usage: java MyTraverseDirectory DirName");
